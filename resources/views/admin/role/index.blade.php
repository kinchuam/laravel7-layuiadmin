        ...
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group">
                ...
                @can('system.role.create')
                    <a class="layui-btn layui-btn-sm" onclick="active.openLayerForm('{{route('admin.role.create')}}','添加角色',{'width':'45%','height':'45%'});">添 加</a>
                @endcan
            </div>
        </div>
            ...
            layui.use(['layer','table'],function () {
                ...
                table.on('tool(dataTable)', function(obj){
                    ...
                    if(layEvent === 'del'){
                        ...
                        active.openLayerForm('{{Request()->getbaseUrl()}}/admin/role/'+data.id+'/edit','编辑角色',{'width':'45%','height':'45%'});
